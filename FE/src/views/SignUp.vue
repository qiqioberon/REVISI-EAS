                    ...
                    <div class="card bg-dark text-white" style="border-radius: 1rem;">
                        <div class="card-body p-5 text-center">
                            <div class="mb-md-5 mt-md-4 pb-5">
                                ...
                                <button class="btn btn-outline-light btn-lg px-5" type="submit" @click="handleSignUp">Sing
                                    Up</button>
                            </div>
                            <div>
                                <p class="mb-0">Already have an account? <RouterLink to="/" class="text-white-50 fw-bold">
                                        Sign In</RouterLink>
                                </p>
                            </div>
                        </div>
